...
[![latest release](https://img.shields.io/github/v/release/komiyamma/hm_ai_translator)](https://github.com/komiyamma/hm_ai_translator/releases/latest)
...
「秀丸エディタ」上で、**HmGoogleGemini** または **HmOpenAiGpt** を利用してテキスト翻訳を行うためのマクロです。
...
といった処理のテンプレートを兼ねますので、様々な応用が可能です。
